...
distcvs:
	...
	$(MV) $(PRECVS)$(PROYECTO) $(PROYECTO)-$(PRY_VERSION)
	if (test "$(PRECVS)" != "") then { $(RM) -rf $(PRECVS); } fi;
...
act-scp:
	if (test ! -x $(SCP)) then { echo "Falta programa scp, instale y configure de nuevo con conf.sh"; exit 1; } fi;
